# -*- coding: utf-8 -*-
"""
Created on Mon Nov  4 20:09:36 2019
...
driver.get("https://www.combinacionganadora.com/euromillones/")
driver.find_element_by_class_name('qc-cmp-button').click()
driver.find_element_by_class_name('qc-cmp-button.qc-cmp-disable-button').click()
...
while fin!= 0:
    ...
    if sorteo=="SI":
        ...
        btton=driver.find_element_by_xpath('//*[@id="resultsDetail"]/div[1]/a/span')
        driver.execute_script("arguments[0].click();", btton)
